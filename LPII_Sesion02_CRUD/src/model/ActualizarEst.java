...
public class ActualizarEst {
	...
	public void actualizarEstudiante(int idEst, Estudiante data) throws Exception{
		...
		if(e==null)
			System.out.println("Esudiante con id: "+idEst + "no existe, no se pudo actualizar");
		else {
...
public static void main(String[] args) {
	...
	try { Estudiante student = new Estudiante();
		student.setNombreApe("Mario Vargas");
		student.setTipoDocumento("DNI");
		student.setNroDocumento("123456789");
		student.setTelefono("987987987");
